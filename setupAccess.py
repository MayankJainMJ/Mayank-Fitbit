...
import traceback
import webbrowser
Dir='C:/Users/mayan/Desktop/Fitbit/Mayank-Fitbit/'
os.chdir(Dir)
...
from iniHandler import ReadCredentials, WriteTokens, WriteCredentials
...
if __name__ == '__main__':
	...
	if not (len(sys.argv) == 3):
		...
		ide, secret = sys.argv[1:]
	else:
		print("Try again giving arguments: client id and client secret.")
		sys.exit(1)

	server = OAuth2Server(ide,secret)
